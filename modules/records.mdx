...
### Using `/record void`
When voiding a record using `/record void`, you are **required** to provide the punishment identification string. Once you run the command, you will be promopted to **confirm or cancel** the deletion. Simply click **Confirm Delete** to delete the record and **Cancel Delete** to cancel the deletion. 
